...
def indicators():
    ...
    fig_09_trace_08 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data8[0].round(2), 'relative': True, 'position' : "top"},
    ...
    fig_09_trace_09 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data9[0].round(2), 'relative': True, 'position' : "top"},
    ...
    fig_09_trace_10 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data10[0].round(2), 'relative': True, 'position' : "top"},
    ...
    fig_09_trace_11 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data11[0].round(2), 'relative': True, 'position' : "top"},
    ...
    fig_09_trace_12 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data12[0].round(2), 'relative': True, 'position' : "top"},
    ...
    fig_09_trace_13 = go.Indicator(
            ...
            number = {'prefix': "$"},
            delta = {'position': "top", 'reference': data13[0].round(2), 'relative': True, 'position' : "top"},
