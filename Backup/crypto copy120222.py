...
def render_content(tab):
    ...
    html.Div(id="Dropdown_menu"),],
        ...
        dcc.Dropdown(id='vol-dropdown',
                     ...
                     placeholder="Select  Volatility type",
                     style=dict(
                         width='40%',
                         verticalAlign="center",
                         justifyContent = 'center',
...
def volatility(selected_crypto):
    ...
    fig.update_layout(
        ...
        title={
            'text': 'Daily Return Trend', # Subplot main title
...
def forecast(selected_crypto, mean, p, o, q, vol, power, dist):
    ...
    #gm_forecast = model_fit.forecast(horizon = 4)

    # Print the forecast variance
    ##print(gm_forecast.variance[-1:])
    
    print(f'GJR-GARCH BIC: {model_fit.bic}')
