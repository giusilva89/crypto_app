...
#  1) Function to collect the data
def get_data():
...
# 2) Function to create the autocorrelation plots
...
app.layout = html.Div(children=[
    html.H1(children='Cryptocurrency Time Series Analysis', style={'font-family': "Verdana", 'text-align': 'center'}),
    html.H4('GARCH & ARCH models',  style={'font-family': "Verdana", 'text-align': 'center'}),
    ...
    html.Div(id="sliderVal")]),
            ...
            html.Div([
                daq.Slider(
                    ...
                    max=20,
                    value=1,
                    #marks={i: f"q {i}" for i in range(0,20, 1)},
